...
vec3 palette( float t, float change ) {
    ...
    vec3 a = vec3(abs(clamp(0.3, 0.8, sin(iTime*0.02))), abs(clamp(0.4, 0.6, sin(iTime*0.03))), abs(clamp(0.2, 0.8,sin(iTime*0.04))))-0.1;
...
//vec3 d = vec3(0.8,0.0,0.0);
     ...
     t * 0.006 + float(iTime)*0.003;
     //vec3 a = vec3(abs(clamp(0.3, 1.0, sin(iTime*0.05))), abs(clamp(0.3, 1.0, sin(iTime*0.03))), abs(clamp(0.3, 1.0,sin(iTime*0.1))))-0.3;
     vec3 b = vec3(-0.542, 0.500, 0.500);
     vec3 c = vec3(1.000, 1.000, 1.000);
     vec3 d = vec3(-0.543, -0.210, 0.123+iTime*0.05);
